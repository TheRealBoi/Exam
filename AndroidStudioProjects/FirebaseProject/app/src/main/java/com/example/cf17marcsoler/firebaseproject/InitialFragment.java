 ...
 * {@link InitialFragment.FragmentInterface} interface
...
public class InitialFragment extends Fragment {
    ...
    EditText emailEdtTxt, psswdEdtTxt;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //region Find EditTexts
        emailEdtTxt = view.findViewById(R.id.Email);
        psswdEdtTxt = view.findViewById(R.id.Passwd);
        //endregion
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mListener.addUser(emailEdtTxt.getText().toString(), psswdEdtTxt.getText().toString());
                emailEdtTxt.setText("");
                psswdEdtTxt.setText("");
            }
        });
        signIn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.signIn(emailEdtTxt.getText().toString(), psswdEdtTxt.getText().toString());
                emailEdtTxt.setText("");
                psswdEdtTxt.setText("");
            }
        });
